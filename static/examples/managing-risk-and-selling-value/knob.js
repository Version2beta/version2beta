...
Knob = function(input, ui) {
  ...
  this.value = input.value = settings.min;
  this.input = input;
...
Ui.Log.prototype = Object.create(Ui.prototype);

Ui.Log.prototype.createElement = function(parentEl) {
  this.parentEl = parentEl
  this.el = new Ui.El.Text('', 0, this.height);
  this.appendTo(parentEl);
  this.el.center(parentEl);
...
Ui.Dials.prototype = Object.create(Ui.prototype);

Ui.Dials.prototype.createElement = function() {
  "use strict";
